...
`}function Q(e){const t=parseInt(e.replace("#",""),16),o=Math.max(0,(t>>16&255)-25),a=Math.max(0,(t>>8&255)-25),r=Math.max(0,(t&255)-25);return`#${(o<<16|a<<8|r).toString(16).padStart(6,"0")}`}const ee='<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',te='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',ne='<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>';function oe(e,t,o){var g;const a={open:!1,submitting:!1,success:!1},r=t==="bottom-left"?"fb-left":"fb-right",c=document.createElement("button");c.className=`fb-btn-float ${r}`,c.setAttribute("aria-label","Submit feedback"),c.innerHTML=ee,c.style.bottom="24px";const i=document.createElement("div");i.className="fb-overlay";const n=document.createElement("div");n.className=`fb-panel ${r}`,n.setAttribute("data-fb-theme","dark"),n.innerHTML=ae(e),document.body.appendChild(i),document.body.appendChild(n),document.body.appendChild(c);function f(){a.open=!0,n.classList.add("fb-open"),i.classList.add("fb-open")}function d(){a.open=!1,n.classList.remove("fb-open"),i.classList.remove("fb-open")}function b(){a.success=!1;const s=n.querySelector(".fb-panel-body");s&&(s.innerHTML=M(e)),m()}function m(){const s=n.querySelector("#fb-feedback-form");s&&s.addEventListener("submit",async l=>{var _,U,R;if(l.preventDefault(),a.submitting)return;const p=n.querySelector("#fb-title"),h=n.querySelector("#fb-desc"),L=n.querySelector("#fb-email"),z=n.querySelector("#fb-category"),v=n.querySelector(".fb-error"),x=n.querySelector("#fb-submit"),F=(_=p==null?void 0:p.value.trim())!=null?_:"",we=(h==null?void 0:h.value.trim())||void 0,A=(U=L==null?void 0:L.value.trim())!=null?U:"",ke=(z==null?void 0:z.value)||void 0;if(F.length<5){v&&(v.textContent="Title must be at least 5 characters.");return}if(!A){v&&(v.textContent="Email is required.");return}a.submitting=!0,x&&(x.disabled=!0),x&&(x.textContent="Submitting...");const Ce=await G(e.slug,{title:F,description:we,categoryId:ke,authorEmail:A});if(a.submitting=!1,!Ce){x&&(x.disabled=!1),x&&(x.textContent="Submit"),v&&(v.textContent="Failed to submit. Please try again.");return}a.success=!0;const B=n.querySelector(".fb-panel-body");B&&(B.innerHTML=`
        ...
        `,(R=n.querySelector("#fb-reset"))==null||R.addEventListener("click",b))})}return c.addEventListener("click",()=>{a.open?d():f()}),i.addEventListener("click",d),(g=n.querySelector(".fb-close"))==null||g.addEventListener("click",d),m(),{open:f,close:d,getButton:()=>c}}function ae(e){return`
  ...
  `}function N(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function re(e){return e.replace(/"/g,"&quot;")}const ie='<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',O="freebase_cl_read_";function se(e){try{const t=localStorage.getItem(`${O}${e}`);return t?JSON.parse(t):[]}catch(t){return[]}}function le(e,t){try{localStorage.setItem(`${O}${e}`,JSON.stringify(t))}catch(o){}}function T(e,t){const o=new Set(se(e));return t.filter(a=>!o.has(a.id)).length}function ce(e,t,o){var g;const a=t==="bottom-left"?"fb-left":"fb-right";let r=[],c=!1;const i=document.createElement("button");i.className=`fb-btn-whats-new ${a}`,i.setAttribute("aria-label","What's new"),i.innerHTML="<span>What's new</span>";const n=document.createElement("div");n.className=`fb-popup ${a} fb-popup-bottom`,n.setAttribute("data-fb-theme","dark"),n.innerHTML=fe(e,o),document.body.appendChild(n),document.body.appendChild(i);function f(){c=!0,n.classList.add("fb-open"),le(e.slug,r.map(s=>s.id)),b(0)}function d(){c=!1,n.classList.remove("fb-open")}function b(s){let l=i.querySelector(".fb-badge");s>0?(l||(l=document.createElement("span"),l.className="fb-badge",i.appendChild(l)),l.textContent=String(s)):l==null||l.remove()}function m(s){const l=n.querySelector(".fb-popup-body");if(l){if(s.length===0){l.innerHTML='<div class="fb-empty">No updates yet.</div>';return}l.innerHTML=s.map(p=>`
    ...
    `).join(""),l.querySelectorAll(".fb-cl-item").forEach(p=>{p.addEventListener("click",()=>{const h=p.getAttribute("data-slug");h&&window.open(`${o}/${e.slug}/changelog/${h}`,"_blank")})})}}return Y(e.slug).then(s=>{r=s,m(r);const l=T(e.slug,r);b(l)}),i.addEventListener("click",()=>{c?d():f()}),(g=n.querySelector(".fb-close"))==null||g.addEventListener("click",d),document.addEventListener("click",s=>{c&&!n.contains(s.target)&&!i.contains(s.target)&&d()}),{open:f,close:d,getUnreadCount:()=>T(e.slug,r),getButton:()=>i}}function fe(e,t){return`
  ...
  `}function H(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function w(e){return e.replace(/"/g,"&quot;")}function de(e){try{return new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch(t){return""}}const be='<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/><line x1="9" y1="3" x2="9" y2="18"/><line x1="15" y1="6" x2="15" y2="21"/></svg>',pe='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>';function ue(e,t,o){var g;const a=t==="bottom-left"?"fb-left":"fb-right";let r=!1,c=!1;const i=document.createElement("button");i.className=`fb-btn-float ${a}`,i.setAttribute("aria-label","Roadmap"),i.innerHTML=be,i.style.bottom="84px";const n=document.createElement("div");n.className="fb-overlay";const f=document.createElement("div");f.className=`fb-panel ${a}`,f.setAttribute("data-fb-theme","dark"),f.innerHTML=me(e),document.body.appendChild(n),document.body.appendChild(f),document.body.appendChild(i);function d(){r=!0,f.classList.add("fb-open"),n.classList.add("fb-open"),c||(c=!0,m())}function b(){r=!1,f.classList.remove("fb-open"),n.classList.remove("fb-open")}async function m(){const s=f.querySelector(".fb-panel-body");if(!s)return;const l=await K(e.slug);if(!l){s.innerHTML='<div class="fb-empty">Could not load roadmap.</div>';return}s.innerHTML=ge(l)}return i.addEventListener("click",()=>{r?b():d()}),n.addEventListener("click",b),(g=f.querySelector(".fb-close"))==null||g.addEventListener("click",b),{open:d,close:b,getButton:()=>i}}function me(e){return`
    <div class="fb-panel-header">
  ...
  `}function $(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}let I=!1,S=null,k="";const u={feedback:null,changelog:null,roadmap:null};async function xe(e){var d,b;if(I)return;I=!0;const{org:t,theme:o="auto",position:a="bottom-right",accentColor:r}=e,c=document.currentScript,i=(d=c==null?void 0:c.src)!=null?d:"";try{k=new URL(i).origin}catch(m){k=window.location.origin}D(k);const n=await J(t);if(!n){console.warn("[Freebase] Could not load org config for:",t);return}S=n;const f=(b=r!=null?r:n.accentColor)!=null?b:"#10b981";V(f),o!=="auto"&&document.documentElement.setAttribute("data-fb-theme",o),u.feedback=oe(n,a),u.changelog=ce(n,a,k),u.roadmap=ue(n,a)}async function he(e){if(!S)return;const t=await X(S.slug,e.jwt);t!=null&&t.token?q(t.token):q(e.jwt)}function ve(e){var t,o,a;e==="feedback"&&((t=u.feedback)==null||t.open()),e==="changelog"&&((o=u.changelog)==null||o.open()),e==="roadmap"&&((a=u.roadmap)==null||a.open())}function ye(e){u.changelog?e(u.changelog.getUnreadCount()):e(0)}async function j(e,...t){switch(e){case"init":await xe(t[0]);break;case"identify":await he(t[0]);break;case"open":ve(t[0]);break;case"getUnreadCount":ye(t[0]);break;default:console.warn("[Freebase] Unknown command:",e)}}function P(){var a;const e=window.Freebase,t=(a=e==null?void 0:e.q)!=null?a:[],o=(...r)=>{j(r[0],...r.slice(1))};window.Freebase=o;for(const r of t)j(r[0],...r.slice(1))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",P):P()})();
